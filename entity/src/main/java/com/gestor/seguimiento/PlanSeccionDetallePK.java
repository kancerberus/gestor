 ...
 */
@Embeddable
public class PlanSeccionDetallePK implements Serializable {
    ...
    public String toString() {
        return "com.gestor.seguimiento.PlanSeccionDetallePK[ codigoEstablecimiento=" + codigoEstablecimiento + ", codTitulo=" + codTitulo + ", codSeccion=" + codSeccion + ", codSeccionDetalle=" + codSeccionDetalle + " ]";
    }
